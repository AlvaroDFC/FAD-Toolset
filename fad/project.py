...
class Project():
    ...
    def loadSite(self, yaml_input, dir=''):
        ...
        # TODO: move to helper after merging, review and clean up the inputs and outputs of this function
        if 'exclusions' in site_dict and site_dict['exclusions']:
            for ex in site_dict['exclusions']:
    ...
    # TODO: move to cable tools/class
    ...
    def plot2d(self, ax=None, plot_soil=False,
        ...
        if line_depth_settings is not None and not bare:
            ...
            # NOTE: I believe cm comes from matplotlib.cm, but it may need explicit import
    ...
    def _build_mooring_anchor_instance_shared(self, arrayMooring, arrayInfo, arrayAnchor, lineConfigs, connectorTypes, alph):
        ...
        for j in range(0, len(arrayMooring)): # run through each line            
            ...
            if any(ids['ID'] == arrayMooring[j]['endA'] for ids in arrayInfo): # shared mooring line (no anchor)
                ...
                # add mooring and anchor to list (no anchor registered here)
                ...
                # add mooring and anchor to list
                mooringList[moor.id]    = moor
